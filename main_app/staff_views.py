...
def staff_home(request):
    ...
    context = {
        'page_title': 'Преподаватель ' + str(staff.admin.last_name) + ' (' + str(staff.course) + ')',
...
def staff_view_profile(request):
    ...
    context = {'form': form, 'page_title': 'Профиль'}
    if request.method == 'POST':
        try:
            if form.is_valid():
                ...
                messages.error(request, "Некорректная информация")
                return render(request, "staff_template/staff_view_profile.html", context)
        except Exception as e:
            messages.error(
                request, "Ошибка " + str(e))
            return render(request, "staff_template/staff_view_profile.html", context)
